    ...
    const renderProducts = (products) => {
        return products.map((product, index) => {
            return <div key={product._id} className={`${styles['body-row']} d-flex ${index % 2 === 0 ? 'bg-row-even' : ''}`}>
                ...
                <div className={`${styles['price']} f-3 text-capitalize ps-2 text-ellipsis`}>{formatPrice(product.price)}</div>
                                ...
                                <div className={`${styles['table']}`}>
                                    <div className={`${styles['header-table']}`}>
                                        <div className={`${styles['header-row']} d-flex`}>
                                            ...
                                            <div className='f-3 text-capitalize ps-2 text-ellipsis'>price</div>
