                        ...
                        <table className={`${styles['table']} w-100`}>
                            ...
                            <tbody>
                                <tr className='w-100'>
                                    ...
                                    <td className='f-3 ps-3 text-capitalize'></td>
                                    <td className='f-3 ps-3 text-capitalize'>
                                        <img className="w-25" alt="" src="" />
                                    </td>
                                    <td className='f-1 ps-3'>
                                        <button onClick={() => {
                                            // deleteArea(area._id)
                                    ...
                                    <td className='f-1 ps-3'>
                                        <Link to={`/admin/area/edit/${1}`} className={`${styles['delete-btn']} text-decoration-none px-2`}>Edit</Link>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
